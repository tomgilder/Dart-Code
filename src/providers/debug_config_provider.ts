...
export class DebugConfigProvider implements DebugConfigurationProvider {
	...
	constructor(private sdks: Sdks, private analytics: Analytics, private deviceManager: FlutterDeviceManager, private dartCapabilities: DartCapabilities, private flutterCapabilities: FlutterCapabilities) { }
	...
	private setupDebugConfig(folder: WorkspaceFolder | undefined, debugConfig: FlutterLaunchRequestArguments, isFlutter: boolean, device: Device | undefined) {
		...
		logWarn(`Debugger supports paths everywhere? ${debugConfig.debuggerHandlesPathsEverywhereForBreakpoints}`);
